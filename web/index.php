...
echo '<div class="content"><form method="get">Mobile Number:<br><input type="text" name="uid" value="'.$uid.'"/><br/>Password:<br><input type="text" name="pwd" value="'.$pwd.'"/><br/>Receipt:<br><input type="text" name="to" value="'.$to.'"/><br/>Message:<br><textarea name="msg"></textarea><br/><input type="submit" value="Send SmS"/></form></div>';
include('foot.php');
